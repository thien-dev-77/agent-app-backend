...
- Tối ưu riêng cho Google Omni Image-to-Video: trong "Prompt video tổng hợp", không mô tả lại ngoại hình chi tiết của người từ ảnh đầu vào như đẹp/xinh, màu tóc, màu váy, dáng mặt, tuổi, màu da, trang phục. Chỉ nhắc "preserve the exact person identity from the reference image(s)" và tập trung mô tả chuyển động.
